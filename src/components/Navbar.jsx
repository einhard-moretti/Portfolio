...
export default function Navbar() {
  ...
  return (
    <header className="nav-in sticky top-0 z-50 bg-base/80 backdrop-blur">
      ...
      >
        ...
        <div className="flex items-center justify-end gap-1">
          ...
          <button
            ...
            className="inline-flex h-11 w-11 items-center justify-center text-muted transition-colors duration-200 hover:text-ink lg:hidden"
          >
      ...
      {open && (
        <div id="mobile-menu" className="bg-base lg:hidden">
